...
function App() {
  ...
  return (
    ...
    isLoggedIn
      ...
      <header className='no-account-header'>
        <ul>
          <li>
        ...
        <ul>
          ...
          <li>Log in</li>
          <li className='get-notion-free'>Get Notion free</li>
        </ul>
      </header>
      ...
      <div className='primary-content'>
        ...
        <p className='get-notion-free'>
          Get Notion free
          <ArrowRight />
        </p>

        <img src='https://www.notion.so/cdn-cgi/image/format=webp,width=2048/https://images.ctfassets.net/spoqsaf9291f/3csRrNi1u82ymVlwjfo2E6/02516e52af15501acd822d3e7a03baf9/home-hero.png' alt='Hero image' width={'640px'}/>
      </div>
